...
# input fields
item_name_label = tk.Label(root, bg='ivory4', text="Item Name:")
item_name_label.grid(row=0, column=0, padx=5, pady=5)
item_name_entry = tk.Entry(root)
item_name_entry.grid(row=0, column=1, padx=5, pady=5)
item_qty_label = tk.Label(root, bg='ivory4', text="Item Quantity:")
...
add_button = tk.Button(root, bg='dark green', activebackground='green', text="Add Inventory", 
					command=add_inventory)
add_button.grid(row=2, column=0, padx=5, pady=5)
update_button = tk.Button(root, bg='yellow4', activebackground='yellow', text="Update Inventory", 
						command=update_inventory)
update_button.grid(row=2, column=1, padx=5, pady=5)
search_button = tk.Button(root, bg='blue4', activebackground='blue', text="Search Inventory", 
						command=search_inventory)
search_button.grid(row=3, column=0, padx=5, pady=5)
remove_button = tk.Button(root, bg='red4', activebackground='red', text="Remove Inventory", 
						command=remove_inventory)
remove_button.grid(row=3, column=1, padx=5, pady=5)
generate_button = tk.Button(root, bg='DeepPink4', activebackground='maroon1', text="Generate Inventory", 
							command=generate_inventory)
generate_button.grid(row=4, column=0, padx=5, pady=5)

result_label = tk.Label(root, bg='ivory4',text="List: ")
result_label.grid(row=5, column=0, padx=5, pady=5)

root.configure(bg='ivory4')
